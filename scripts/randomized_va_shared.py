...
parser.add_argument("-a", "--af", action="store", required=True, help="Allele frequency cutoff for calling SNPs shared")
...
print(estimate, conf_interval[0], conf_interval[1], stderr, bias, W, M, args.af, args.file)
